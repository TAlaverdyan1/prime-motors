...
const Branches = () => {
    ...
    const currentBranchesSection = (branchesSection as BranchesInfoSection)[locale as keyof BranchesInfoSection];


    return (
        <div className=" mt-20">
            <div className=" text-red font-bold text-[30px] uppercase text-center px-4">{currentBranchesSection?.title}</div>
