...
const Partners = () => {
    ...
    return (
        <div className=" mt-20">
            <div className=" text-red font-bold text-[30px] capitalize text-center px-4">{currentPartnersSection.title}</div>
            {
                    ...
                    <div key={el.id} className={` block custom:flex items-center mt-8 ${el.id % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                        <div className=" text-center text-[16px] px-4 py-10 custom:w-1/2 md:text-[17px] lg:px-12 xl:px-24">
                            ...
                            <Link
                                ...
                                href={el.link}>
                                <span className=" hover:border-b-2 hover:border-b-red">{el.btn_text}</span>
                            </Link>
                        </div>
