...
import { PartnersInfoSection, PromotionInfoSection, PromotionSectionContent } from "@/models/models";

const Promotion = () => {
    const currentLanguage = useLanguage();

    const currentPromotionSection = promotionSection[currentLanguage as keyof PartnersInfoSection];
