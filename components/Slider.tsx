        ...
        <div className=" w-[100%] h-[100vh]">
            {
                currentSlider.map((el: SliderItem) => (
                    <div key={el.id}
                        ...
                        <div className=" text-[1.5rem] px-4 text-white capitalize font-bold md:px-6 md:text-[2rem] lg:px-24 lg:text-[3rem] z-10">{el.title}</div>
                        <Link href={el.route} className=" p-3 bg-red text-white font-bold md:px-8 md:py-4 md:text-[20px] capitalize z-10">{el.btn_text}</Link>
                    </div>
                ))
            }
